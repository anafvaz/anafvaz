...
### Canadian Surgical Wait Times Dashboard (Power BI)
Analysis of CIHI surgical wait time data across 10 Canadian provinces from 2020 to 2024. Patient volume has nearly doubled since 2020 — wait times have not recovered. 7 out of 10 provinces still exceed the pre-pandemic median baseline for hip replacement. Built with a focus on the 90th percentile, where the most vulnerable patients sit and where the least improvement has occurred.
